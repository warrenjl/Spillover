...
## Statistical Model
$$y_i\left(\textbf{s}_i\right)|p_i\left(\textbf{s}_i\right) \stackrel{\text{ind}}{\sim} \text{Bernoulli}\left(p_i\left(\textbf{s}_i\right)\right),\ i=1,...,n;$$
...
* $\phi = \max\left\{||\textbf{s}_i - \textbf{s}_p||: i=1,...,n\right\}/2$.
